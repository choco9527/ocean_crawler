...
function isHtml(request) {
    ...
    console.log(_headers['content-type'])
    return _headers['content-type'] && _headers['content-type'].includes('text/html')
}
...
module.exports = {getPath, mockClick, mockDrag, _parsePostData, isHtml, _grayData, _similarImg, randn_bm, K};
